...
| 4 | [Kth Largest Element in Stream](https://leetcode.com/problems/kth-largest-element-in-a-stream/) | Easy | ⬜ Todo |
...
### [295. Median from Data Stream](https://leetcode.com/problems/find-median-from-data-stream/) (Hard)
Design a data structure that supports:
- `addNum(num)` — adds a number to the data stream
- `findMedian()` — returns the median of all numbers so far

### [703. Kth Largest Element in Stream](https://leetcode.com/problems/kth-largest-element-in-a-stream/) (Easy)
Design a data structure that supports:
...
### [432. All O(1) Data Structure](https://leetcode.com/problems/all-oone-data-structure/) (Hard)
Design a data structure that supports:
- `inc(key)`
- `dec(key)`
- `getMaxKey()`
...
### [340. Longest Substring with K Distinct Characters](https://leetcode.com/problems/longest-substring-with-at-most-k-distinct-characters/) (Medium)
...
### [297. Serialize / Deserialize Binary Tree](https://leetcode.com/problems/serialize-and-deserialize-binary-tree/) (Hard)
Implement:
...
### [642. Autocomplete System](https://leetcode.com/problems/design-search-autocomplete-system/) (Hard)
Implement:
